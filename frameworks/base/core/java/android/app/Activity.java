    ...
    public void onWindowFocusChanged(boolean hasFocus) {
        ...
        if (hasFocus && Build.VERSION.SDK_INT >= 19) {
            ...
            if("com.android.launcher3".equals(getPackageName())) {
                ...
                Log.d("ACTIVITY_DOOM", "onWindowFocusChanged uiFlags:" + uiFlags);
                Log.d("ACTIVITY_DOOM", "onWindowFocusChanged PackageName:" + getPackageName());
                if("com.chaozh.iReaderFree".equals(getPackageName())
                        || "com.timuzsolutions.archery3d".equals(getPackageName())) {
                    Log.d("ACTIVITY_DOOM", "onWindowFocusChanged FULL SCREEN");
