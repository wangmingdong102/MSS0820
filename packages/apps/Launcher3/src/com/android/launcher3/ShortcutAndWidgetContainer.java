...
public class ShortcutAndWidgetContainer extends ViewGroup {
    ...
    public void setCellDimensions(int cellWidth, int cellHeight, int widthGap, int heightGap,
        ...
        /* mssflexiblescreen */
		Log.d(TAG, "setCellDimensions mIsHotseatLayout:"+mIsHotseatLayout);
        //if(mCellHeight == 40) {
        //    new Exception("msslog").printStackTrace();
        //}
		/* mssflexiblescreen */
        mWidthGap = widthGap;
    ...
    public void measureChild(View child) {
        ...
        int childheightMeasureSpec = MeasureSpec.makeMeasureSpec(lp.height,
                MeasureSpec.EXACTLY);
        /* mssflexiblescreen */
		Log.d(TAG, "msslog measureChild child:"+child);
        Log.d(TAG, "msslog measureChild mIsHotseatLayout:"+mIsHotseatLayout);
        Log.d(TAG, "msslog measureChild childheightMeasureSpec:"+childheightMeasureSpec);
        Log.d(TAG, "msslog measureChild lp.height:"+lp.height);
        Log.d(TAG, "msslog measureChild mCellHeight:"+mCellHeight);
		/* mssflexiblescreen */
