...
public class CellLayout extends ViewGroup implements BubbleTextShadowHandler {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mFixedCellWidth < 0 || mFixedCellHeight < 0) {
            ...
            /* mssflexiblescreen */
			Log.d(TAG, "msslog onMeasure childHeightSize:"+childHeightSize);
            Log.d(TAG, "msslog onMeasure mCountY:"+mCountY);
			/* mssflexiblescreen */
    ...
    */
    ...
    /**
     * M,OP09: Whether the given cell exceed the last position.
     *
     * @param cell
     * @return
     */
