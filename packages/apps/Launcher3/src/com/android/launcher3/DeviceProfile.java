...
public class DeviceProfile {
            ...
            if (isTablet) {
                ...
                if (isLandscape) {
                    bounds.set(desiredWorkspaceLeftRightMarginPx - defaultWidgetPadding.left,
                            0/*getSearchBarTopOffset()*/,
                            availableWidthPx - (desiredWorkspaceLeftRightMarginPx -
                                    defaultWidgetPadding.right), 1/*searchBarSpaceHeightPx*/);
                }else
				/* mssflexiblescreen */
				{
                    bounds.set(desiredWorkspaceLeftRightMarginPx - defaultWidgetPadding.left,
    ...
    public void layout(Launcher launcher) {
        ...
        if(isLandscape && mSplit){
            lp.width = ((width - padding.left - padding.right)/2);
        }
		/* mssflexiblescreen */
        workspace.setLayoutParams(lp);
		/* mssflexiblescreen */
        Log.d("DeviceProfile", "layout workspace lp.width:"+lp.width);
        Log.d("DeviceProfile", "layout workspace padding.left:"+padding.left);
        Log.d("DeviceProfile", "layout workspace padding.right:"+padding.right);
		/* mssflexiblescreen */
        ...
        if (hasVerticalBarLayout) {
            ...
            /* mssflexiblescreen */
			if(isLandscape && mSplit){
                lp.width = ((width - (4 * edgeMarginPx))/2);
            }
			/* mssflexiblescreen */
            lp.height = hotseatBarHeightPx;
            hotseat.findViewById(R.id.layout).setPadding(2 * edgeMarginPx, 0,
                    2 * edgeMarginPx, 0);
            /* mssflexiblescreen */
			Log.d("DeviceProfile", "layout hotseat lp.width:"+lp.width);
            Log.d("DeviceProfile", "layout hotseat padding.left:"+(2 * edgeMarginPx));
            Log.d("DeviceProfile", "layout hotseat padding.right:"+(2 * edgeMarginPx));
			/* mssflexiblescreen */
        }
