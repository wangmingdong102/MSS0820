...
class AllAppsList {
    ...
    public static ArrayList<String> blockAppList = new ArrayList<String>();
    public boolean shouldShowApp(ComponentName componentName){
        if(blockAppList.size() == 0) {
            blockAppList.add("com.mediatek.hotknot.verifier");
//            blockAppList.add("com.xxd.android");
            blockAppList.add("com.android.stk");
            blockAppList.add("com.mediatek.datatransfer");
            blockAppList.add("com.android.development");
            blockAppList.add("com.mss.lcd");
            blockAppList.add("com.android.quicksearchbox");
            blockAppList.add("com.mediatek.mco");
            blockAppList.add("com.cootek.smartinputv5");
            blockAppList.add("com.mediatek.camera");
            blockAppList.add("com.android.fmradio");
            blockAppList.add("com.android.soundrecorder");
            blockAppList.add("com.microsoft.office.powerpoint");
        }
        if(blockAppList.size() > 0){
            if(blockAppList.contains(componentName.getPackageName())){
                return false;
            }
        }
        return true;
    ...
    public void add(AppInfo info) {
        //wangmingdong
        Log.d(TAG, "add appinfo packagename:"+info.componentName.getPackageName());
        Log.d(TAG, "add appinfo classname:"+info.componentName.getClassName());
        if(!shouldShowApp(info.componentName)){
            return;
        }
        //wangmingdong
