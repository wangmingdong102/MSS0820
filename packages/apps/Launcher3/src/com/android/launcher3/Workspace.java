...
public class Workspace extends PagedView
    ...
    public void removeExtraEmptyScreenDelayed(final boolean animate, final Runnable onComplete,
        ...
        if (hasExtraEmptyScreen()) {
            ...
            if (getNextPage() == emptyIndex) {
                ...
                ///the duration should be 0, or else, it has time sequence issue.
                if (Utilities.isRtl(getResources())
                    && mState == State.SPRING_LOADED) {
                    fadeAndRemoveEmptyScreen(0, 0,
            ...
            if (getScreenWithId(screenId) == null) {
                ...
                new Throwable().printStackTrace();
                   ...
                   long maxScreenId = -1;
                    ...
                    //op09 LauncherAppState.getLauncherProvider().updateMaxScreenId(maxScreenId);
                    mLauncher.getModel().updateWorkspaceScreenOrder(mLauncher, mScreenOrder);
                    //return;
                    /// M.
            }
    ...
    public void computeScroll() {
        super.computeScroll();
        /// M: ALPS02295402, add patch ALPS02195756,,add patch ALPS02195756,
...
/*        for (int i = 0; i < getChildCount(); i++) {
            ...
            if (v != null) {
                ...
                float rotation = - TRANSITION_MAX_ROTATION * 5 * scrollProgress;
        ...
        for (int i = 0; i < getChildCount(); i++) {
            ...
            if (v != null) {
                float scrollProgress = getScrollProgress(screenCenter, v, i);
                //根据滑动位置设置每个屏幕的动画效果
                PageViewAnimation.getInstance().pageViewAnime(scrollProgress, i, getChildCount(), mDensity, v, this);
            }
        }
        /* mssflexiblescreen */
    }
   ...
   static private float squaredDistance(float[] point1, float[] point2) {
    ...
    void setup(DragController dragController) {
        ...
        if(mDragController != null && mWindowToken != null) {
            mDragController.setWindowToken(mWindowToken);
        }
